...
llxHeader('', $langs->trans('FixitoQuickSale'));

print load_fiche_titre($langs->trans('FixitoQuickSale'), '', 'fa-shopping-cart');
print '<div class="info">'.$langs->trans('FixitoHelpQuickSale').'</div>';
